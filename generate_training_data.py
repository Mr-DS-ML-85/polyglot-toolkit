...
POLYGLOT_TYPES = {
    ...
    # ── macOS Mach-O Binary Polyglots ─────────
    "macho_in_jpg":     {"types": ["jpg", "macho64"], "severity": "critical",
                         "desc": "Mach-O 64-bit binary in JPEG (macOS)"},
    "macho_in_png":     {"types": ["png", "macho64"], "severity": "critical",
                         "desc": "Mach-O 64-bit binary in PNG (macOS)"},
    "macho_in_gif":     {"types": ["gif", "macho64"], "severity": "critical",
                         "desc": "Mach-O 64-bit binary in GIF (macOS)"},
    "macho_in_bmp":     {"types": ["bmp", "macho64"], "severity": "critical",
                         "desc": "Mach-O 64-bit binary in BMP (macOS)"},
    "macho_in_pdf":     {"types": ["pdf", "macho64"], "severity": "critical",
                         "desc": "Mach-O 64-bit binary in PDF (macOS)"},
    "macho32_in_jpg":   {"types": ["jpg", "macho32"], "severity": "critical",
                         "desc": "Mach-O 32-bit binary in JPEG (macOS legacy)"},
    "macho32_in_png":   {"types": ["png", "macho32"], "severity": "critical",
                         "desc": "Mach-O 32-bit binary in PNG (macOS legacy)"},
...
EXEC_HEADERS = {
    ...
    "sh":   b'#!/bin/sh\n',
    "bash": b'#!/bin/bash\n',
    "macho64": b'\xcf\xfa\xed\xfe\x07\x00\x00\x01\x03\x00\x00\x00\x02\x00\x00\x00\x0e\x00\x00\x00\xa0\x06\x00\x00\x85\x00\x20\x00\x00\x00\x00\x00',
    "macho32": b'\xce\xfa\xed\xfe\x07\x00\x00\x00\x03\x00\x00\x00\x02\x00\x00\x00\x0e\x00\x00\x00\xa0\x06\x00\x00\x85\x00\x20\x00\x00\x00\x00\x00',
